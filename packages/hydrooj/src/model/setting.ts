...
SystemSetting(Schema.object({
    ...
    'sms.aliyun.enabled': Schema.boolean().default(false).description('Enable Aliyun SMS registration').extra('family', 'setting_sms'),
    'sms.aliyun.accessKeyId': Schema.string().default('').description('Aliyun AccessKey ID').role('password').extra('family', 'setting_sms'),
    'sms.aliyun.accessKeySecret': Schema.string().default('').description('Aliyun AccessKey Secret').role('password').extra('family', 'setting_sms'),
    'sms.aliyun.endpoint': Schema.string().default('dypnsapi.aliyuncs.com').description('Aliyun SMS endpoint').extra('family', 'setting_sms'),
    'sms.aliyun.signName': Schema.string().default('').description('Aliyun SMS sign name').extra('family', 'setting_sms'),
    'sms.aliyun.templateCode': Schema.string().default('').description('Aliyun SMS template code').extra('family', 'setting_sms'),
    'sms.aliyun.codeLength': Schema.number().step(1).min(4).max(8).default(6).description('SMS verification code length').extra('family', 'setting_sms'),
    'sms.aliyun.expireSeconds': Schema.number().step(1).min(60).max(1800).default(300).description('SMS verification code lifetime').extra('family', 'setting_sms'),
